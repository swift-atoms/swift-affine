...
//
// File covers a previous-generation `Affine.Point` continuous-coordinate type.
// `Affine.Point` is not part of the 0.1.0 discrete surface; the current
// equivalents are `Tagged<Tag, Ordinal>` (typed positions, in `swift-ordinal-primitives`)
// and the affine arithmetic in `OrdinalAffineArithmeticTests.swift`.
