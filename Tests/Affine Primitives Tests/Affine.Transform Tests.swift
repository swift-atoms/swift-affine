...
//
// File covers a previous-generation `Affine.Transform` matrix transform type.
// Out of scope for the 0.1.0 discrete surface; belongs in a future continuous-
// affine package together with `Affine.Point` / `Affine.Translation`.
...
//           // scale ×2: (0,11) -> (0,22)
//           #expect(isApprox(result.x, A.X(0)))
//           #expect(isApprox(result.y, A.Y(22)))
//       }
////
//       @Test
...
//           let translation = A.Translation(dx: 5.0, dy: 6.0)
