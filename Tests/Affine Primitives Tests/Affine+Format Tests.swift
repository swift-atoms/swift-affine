...
//
// File covers the previous-generation `Affine+Formatting` extensions that don't
// exist in the current 0.1.0 surface. Smoke coverage for the current surface's
// `CustomStringConvertible` lives at `AffineVectorTests.swift`.
